...
function mainTest(solver::formalA2.QSSAlgorithm{solType, V})where {V,solType} 
    ...
    #cfuns=[C1,C2,C3,C4,C5,C6,C7,C8,C18,C70,C71,C92,C98,C99,C108,C109,C120,C130,C141,C142,C149,C154,C155,C164,C165,C176,C177,C186,C187,C192,C202,C208,C209]
    cfuns=[C141]
    cResults=[]
    for fun in cfuns
      @show fun
    ...
    #@show cResults
    #= XLSX.openxlsx("LTI_C_$(solType).xlsx", mode="w") do xf
      sheet = xf[1]
      sheet["A1"] = "LTI_C"
