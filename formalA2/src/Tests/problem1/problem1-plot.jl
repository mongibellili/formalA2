...
include("D://formalqssA//formalqssA//src//models//NonLinear.jl")
function test()
 ...
 #=  solqss2=QSS_Solve_from_model(oregonator,odeprob,10.0,qss2(),saveat(0.1),0.0,1e-6,1e-3)
  save_Sol(solqss2)
  solqss2=QSS_Solve_from_model(oregonator,odeprob,10.0,qss3(),saveat(0.1),0.0,1e-6,1e-3)
  save_Sol(solqss2) =#
 #=  solqss2=QSS_Solve_from_model(oregonator,odeprob,10.0,qss2(),saveat(0.1),0.0,1e-6,1e-3)
  save_Sol(solqss2) =#
  #= solqss2=QSS_Solve_from_model(oregonator,odeprob,10.0,liqss3(),saveat(0.1),0.0,1e-6,1e-3)
  save_Sol(solqss2)
  solqss2=QSS_Solve_from_model(oregonator,odeprob,10.0,mliqss2(),saveat(0.1),0.0,1e-6,1e-3)
  save_Sol(solqss2)
  solqss2=QSS_Solve_from_model(oregonator,odeprob,10.0,mliqss3(),saveat(0.1),0.0,1e-6,1e-3)
  save_Sol(solqss2)
  =#
