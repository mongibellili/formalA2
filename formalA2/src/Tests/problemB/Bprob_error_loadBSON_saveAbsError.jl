...
#= function test11()
    BSON.@load "sysB/formalAB_sysB11_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
   ...
   #=  er1a=getIntervalError(solmliqss2,1,x1,0.0,20.0)  
    er2a=getIntervalError(solmliqss2,2,x2,0.0,20.0)  
    er1b=getIntervalError(solmliqss2,1,x1,20.0,1000.0)  
    er2b=getIntervalError(solmliqss2,2,x2,20.0,1000.0)  =# 
...
err11=test11()
function test12()
    BSON.@load "sysB/formalAB_sysB12_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
err12=test12()
function test13()
    BSON.@load "sysB/formalAB_sysB13_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
err13=test13()
function test14()
    BSON.@load "sysB/formalAB_sysB14_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
err14=test14()
function test15()
    BSON.@load "sysB/formalAB_sysB15_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
function test21()
    BSON.@load "sysB/formalAB_sysB21_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
   ...
   #=  er1=getError(solmliqss2,1,x1)  
    er2=getError(solmliqss2,2,x2) 
    #= er1a=getIntervalError(solmliqss2,1,x1,0.0,60.0)  
    er2a=getIntervalError(solmliqss2,2,x2,0.0,60.0)  
    er1b=getIntervalError(solmliqss2,1,x1,60.0,1000.0)  
    er2b=getIntervalError(solmliqss2,2,x2,60.0,1000.0)   =#
...
err21=test21()
function test22()
    BSON.@load "sysB/formalAB_sysB22_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err22=test22()
function test23()
    BSON.@load "sysB/formalAB_sysB23_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err23=test23()
function test24()
    BSON.@load "sysB/formalAB_sysB24_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err24=test24()
function test25()
    BSON.@load "sysB/formalAB_sysB25_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err25=test25()
function test31()
    BSON.@load "sysB/formalAB_sysB31_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
...
err31=test31()
function test32()
    BSON.@load "sysB/formalAB_sysB32_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
err32=test32()
function test33()
    BSON.@load "sysB/formalAB_sysB33_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
err33=test33()
function test34()
    BSON.@load "sysB/formalAB_sysB34_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
err34=test34()
function test35()
    BSON.@load "sysB/formalAB_sysB35_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
err35=test35()
 =#
function test41()
    BSON.@load "sysB/formalAB_sysB41_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
...
err41=test41()
function test42()
    BSON.@load "sysB/formalAB_sysB42_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
function test43()
    BSON.@load "sysB/formalAB_sysB43_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err43=test43()
function test44()
    BSON.@load "sysB/formalAB_sysB44_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err44=test44()
function test45()
    BSON.@load "sysB/formalAB_sysB45_mliqss2_errorE-3_step0.1_ft1000.bson" solmliqss2
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
   
    c1, c2 = -95.6165813230446, 95.6165813230446
    xp1, xp2 = 1.0, -2.0
    x1(t)=c1*u1*exp(λ1*t)+c2*u2*exp(λ2*t)+xp1
    x2(t)=c1*exp(λ1*t)+c2*exp(λ2*t)+xp2
...
#= 
 XLSX.openxlsx("relaxedqssA.xlsx", mode="w") do xf
    sheet = xf[1]
   
    sheet["A1"] = "relaxedqssA"
