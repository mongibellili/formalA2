...
#= function test11()
    BSON.@load "sysB/relaxedA_sysB11_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
...
err11=test11()
function test12()
    BSON.@load "sysB/relaxedA_sysB12_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
err12=test12()
function test13()
    BSON.@load "sysB/relaxedA_sysB13_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
err13=test13()
function test14()
    BSON.@load "sysB/relaxedA_sysB14_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
err14=test14()
function test15()
    BSON.@load "sysB/relaxedA_sysB15_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.06805253887502617, -0.5248046039821167
    λ1, λ2 = -3.523632227874817, -0.32636777212518275
...
function test21()
    BSON.@load "sysB/relaxedA_sysB21_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
...
err21=test21()
function test22()
    BSON.@load "sysB/relaxedA_sysB22_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err22=test22()
function test23()
    BSON.@load "sysB/relaxedA_sysB23_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err23=test23()
function test24()
    BSON.@load "sysB/relaxedA_sysB24_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err24=test24()
function test25()
    BSON.@load "sysB/relaxedA_sysB25_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.03593893348744506, -1.739061066512555
    λ1, λ2 = -6.856244266050219, -0.04375573394978005
...
err25=test25()
function test31()
    BSON.@load "sysB/relaxedA_sysB31_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
...
err31=test31()
function test32()
    BSON.@load "sysB/relaxedA_sysB32_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
err32=test32()
function test33()
    BSON.@load "sysB/relaxedA_sysB33_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
err33=test33()
function test34()
    BSON.@load "sysB/relaxedA_sysB34_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
err34=test34()
function test35()
    BSON.@load "sysB/relaxedA_sysB35_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.02252283136759291, -1.6649771686324073
    λ1, λ2 = -6.909908674529628, -0.3400913254703717
...
function test41()
    BSON.@load "sysB/relaxedA_sysB41_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
...
err41=test41()
function test42()
    BSON.@load "sysB/relaxedA_sysB42_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
function test43()
    BSON.@load "sysB/relaxedA_sysB43_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err43=test43()=#
#= function test44()
    BSON.@load "sysB/relaxedA_sysB44_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
#= 
function test444()
    BSON.@load "sysB/relaxedA_sysB44_mliqss2_errorE-3_step0.01_ft1000.bson" solmliqss2
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err44=test444()  =#
#= function test45()
    BSON.@load "sysB/relaxedA_sysB45_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -0.1144790629155213, -0.13539593708447864
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
function test51()
    BSON.@load "sysB/relaxedA_sysB51_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
...
err51=test51()
function test551()
    BSON.@load "sysB/relaxedA_sysB51_mliqss2_errorE-3_step0.01_ft1000.bson" solmliqss2
    u1, u2 = -8.73522174738572, -7.385745994549763
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err51=test551()
#= function test52()
    BSON.@load "sysB/relaxedA_sysB52_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -8.73522174738572, -7.385745994549763
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
function test53()
    BSON.@load "sysB/relaxedA_sysB53_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -8.73522174738572, -7.385745994549763
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err53=test53()
function test54()
    BSON.@load "sysB/relaxedA_sysB54_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -8.73522174738572, -7.385745994549763
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err54=test54() 
function test55()
    BSON.@load "sysB/relaxedA_sysB55_mliqss2_errorE-3_step0.1_ft1000_Interp.bson" solmliqss2Interp
    u1, u2 = -8.73522174738572, -7.385745994549763
    λ1, λ2 = -10.841674966758294, -9.168325033241706
...
err55=test55()
 ...
 XLSX.openxlsx("relaxedqssA_Interp_______.xlsx", mode="w") do xf
    sheet = xf[1]
